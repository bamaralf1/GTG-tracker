...
function renderHistory() {
  ...
  a && (r = r.filter(e => e.data === a)), t && (r = r.filter(e => e.exercicioId === t)), "recente" === o ? r.sort((e, a) => a.timestamp - e.timestamp) : "antigo" === o ? r.sort((e, a) => e.timestamp - a.timestamp) : "exercicio" === o ? r.sort((e, a) => (e.exercicioNome || "").localeCompare(a.exercicioNome || "")) : "xp" === o && r.sort((e, a) => (a.xp || 0) - (e.xp || 0)), 0 !== r.length ? e.innerHTML = r.slice(0, 200).map(e => {
...
function mostrarModalAtalhos() {
  ...
  e.textContent = "\n    @media (min-width: 1200px) {\n      #tab-treino .exercise-grid {\n        grid-template-columns: repeat(3, 1fr) !important;\n      }\n      #tab-stats .grid-2 {\n        grid-template-columns: 1fr 1fr !important;\n      }\n      .main {\n        max-width: 1400px;\n      }\n    }\n    @media (min-width: 1400px) {\n      #tab-treino.active {\n        display: grid !important;\n        grid-template-columns: 1fr 380px;\n        gap: 20px;\n        align-items: start;\n      }\n      #tab-treino.active > .frase-card,\n      #tab-treino.active > .grid-4,\n      #tab-treino.active > .readiness-card,\n      #tab-treino.active > .card:has(#xpBarFill),\n      #tab-treino.active > .foco-banner,\n      #tab-treino.active > .section-divider,\n      #tab-treino.active > .exercise-grid {\n        grid-column: 1;\n      }\n      #tab-treino.active > .card:has(#timerDisplay) {\n        grid-column: 2;\n        grid-row: 1 / 8;\n        position: sticky;\n        top: 90px;\n      }\n      #tab-treino.active > .card:has(#newExName) {\n        grid-column: 1;\n      }\n    }\n  ", document.head.appendChild(e)
}(), document.addEventListener("keydown", e => {
...
const I18N_DICT = {
  pt: {
    tab_treino: "TREINO",
    tab_stats: "PROGRESSO",
    tab_badges: "CONQUISTAS",
    tab_historico: "HISTÓRICO",
    tab_metodo: "MÉTODO GTG",
  ...
  en: {
    tab_treino: "TRAINING",
    tab_stats: "PROGRESS",
    tab_badges: "ACHIEVEMENTS",
    tab_historico: "HISTORY",
    tab_metodo: "GTG METHOD",
    tab_exportar: "EXPORT",
    tab_planejador: "PLAN",
    ...
    modo_foco: "FOCUS MODE"
  },
  ru: {
    tab_treino: "ТРЕНИРОВКА",
    tab_stats: "ПРОГРЕСС",
    tab_badges: "ДОСТИЖЕНИЯ",
    tab_historico: "ИСТОРИЯ",
    tab_metodo: "МЕТОД GTG",
...
function aplicarIdioma(lang) {
  ...
  document.documentElement.setAttribute('lang', lang === 'pt' ? 'pt-BR' : lang === 'ru' ? 'ru' : 'en');
}
